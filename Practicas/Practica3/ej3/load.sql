...
-- Tabla Ciudad
INSERT INTO Ciudad (codCiudad, nombre, pais) VALUES
...
-- Tabla Aerolinea
INSERT INTO Aerolinea (codAerolinea, nombre, origen) VALUES
...
-- Tabla Cliente
INSERT INTO Cliente (codCliente, nombre, apellido, pasaporte, nacionalidad) VALUES
(1, 'Juan', 'Pérez', 'A12345', 'Argentina'),
...
-- Tabla Vuelo
INSERT INTO Vuelo (codVuelo, fecha, hora, cod_ciudad_origen, cod_ciudad_destino, cantidad_pasajes, codAerolinea) VALUES
('101', '2018-01-15', '08:00:00', 6, 1, 3, 1),
...
-- Tabla Pasaje
INSERT INTO Pasaje (codReserva, asiento, codVuelo, codCliente, precio) VALUES
(1, '1A', '101', 1, 500.00),
(2, '2B', '102', 1, 600.00),
(3, '3C', '103', 1, 700.00),
(4, '4D', '104', 1, 800.00),
